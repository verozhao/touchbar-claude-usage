...
struct Config {
    ...
    var keepAwake: Bool = true         // stop macOS from dimming / blanking the Touch Bar when idle
    ...
    static func load(from url: URL) -> Config {
        ...
        if let v = o["keep_awake"] as? Bool { c.keepAwake = v }
        return c
    }
    ...
    func save(to url: URL) {
        let o: [String: Any] = ["wait_seconds": waitSeconds, "refresh_seconds": refreshSeconds,
                                ...
                                "sound": sound, "show_tray": showTray, "menu_bar_details": menuBarDetails, "show_menu_bar": showMenuBar, "keep_awake": keepAwake]
